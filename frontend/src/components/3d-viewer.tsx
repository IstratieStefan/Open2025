...
import { OrbitControls, Grid, Box, Environment } from '@react-three/drei'
...
function ScanVolume({ width = 10, height = 10, depth = 10 }: { width?: number, height?: number, depth?: number }) {
  return (
...
export function Model3DViewer({ modelData, scanVolume = { width: 10, height: 10, depth: 10 } }: Model3DViewerProps) {
        ...
        <div className="absolute bottom-4 left-4 bg-background/80 backdrop-blur-sm rounded-lg p-3">
          <div className="text-sm space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground">Left click + drag to rotate</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <Move3D className="h-4 w-4 text-muted-foreground" />
              <span className="text-muted-foreground">Right click + drag to pan</span>
            </div>
          </div>
        </div>
      </div>
